...
#logdriver::add_log(username = "hello", event = "saw ring", description = "wowwwwwwwwwww")
...
# Sys.setenv("LOGDRIVER_APPNAME" = "testapp")
# logdriver::add_log(username = "hello", event = "saw ring", description = "wowwwwwwwwwww")
logdriver::add_log(username = "hello", event = "saw ring", description = "wowwwwwwwwwww", logdriver_host= "sadfasdf")
